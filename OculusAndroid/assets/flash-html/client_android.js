...
function loaded() {
	document.getElementById("blob").innerHTML = "SKLLOOOBB";
}
...
function blobb() {
	document.getElementById("blob").innerHTML = "FUCCCKKK";
}

function callServer(fn, str) {
	getFlashMovie("oculus_player_android").flashCallServer(fn,str);
}
...
function play(str) {
	...
	getFlashMovie("oculus_player_android").flashplay(num);
}

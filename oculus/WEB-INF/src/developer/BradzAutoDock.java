...
public class BradzAutoDock implements Docker {
	...
	private static Logger log = Red5LoggerFactory.getLogger(BradzAutoDock.class, "oculus");
	...
	/** */
	public BradzAutoDock(Application theapp, IConnection thegrab, ArduinoCommDC com){
		this.app = theapp;
